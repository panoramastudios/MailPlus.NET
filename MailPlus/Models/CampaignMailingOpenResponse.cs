...
namespace MailPlus.Models
{
    ...
    public partial class CampaignMailingOpenResponse
    {
        ...
        /// class.
        /// </summary>
        public CampaignMailingOpenResponse(IList<CampaignMailingOpen> opens = default(IList<CampaignMailingOpen>), Paging paging = default(Paging))
        {
            Opens = opens;
            Paging = paging;
        }
        ...
        public IList<CampaignMailingOpen> Opens { get; set; }
